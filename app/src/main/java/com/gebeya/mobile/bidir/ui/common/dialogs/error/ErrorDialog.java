...
public class ErrorDialog extends BaseDialog {
    ...
    public static ErrorDialog newInstance(@NonNull String title, @NonNull String message) {
        return newInstance(title, message, null);
    }

    public static ErrorDialog newInstance(@NonNull  String title, @NonNull String message, @Nullable String extra) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (extra == null) {
            ...
            extraContainer.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        getBt(R.id.errorDialogOkayButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onErrorDialogDismissed();
                dismiss();
            }
        });
    ...
    public void setCallback(@NonNull ErrorDialogCallback callback) {
