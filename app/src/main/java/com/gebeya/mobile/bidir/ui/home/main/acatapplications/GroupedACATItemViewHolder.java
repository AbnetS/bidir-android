...
public class GroupedACATItemViewHolder extends RecyclerView.ViewHolder implements
        ACATApplicationsContract.GroupItemView, View.OnClickListener {
    ...
    public GroupedACATItemViewHolder(View itemView, ACATApplicationsContract.Presenter presenter) {
        super(itemView);
    ...
    public void setStatus(@NonNull String status) {
        ...
        int id;
        switch (status) {
            case GroupedACATParser.STATUS_LOCAL_NEW:
                id = R.string.acat_applications_fragment_status_new;
                break;
            case GroupedACATParser.STATUS_LOCAL_IN_PROGRESS:
                id = R.string.acat_applications_fragment_status_in_progress;
                break;
            case GroupedACATParser.STATUS_LOCAL_SUBMITTED:
                id = R.string.acat_applications_fragment_status_submitted;
                break;
            case GroupedACATParser.STATUS_LOCAL_RESUBMITTED:
                id = R.string.acat_applications_fragment_status_resubmitted;
                break;
            case GroupedACATParser.STATUS_LOCAL_AUTHORIZED:
                id = R.string.acat_applications_fragment_status_accepted;
                color = R.color.green;
                break;
            case GroupedACATParser.STATUS_LOCAL_DECLINED_FOR_REVIEW:
