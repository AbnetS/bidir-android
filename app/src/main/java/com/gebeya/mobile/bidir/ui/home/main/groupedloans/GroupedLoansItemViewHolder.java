...
public class GroupedLoansItemViewHolder extends RecyclerView.ViewHolder implements
        GroupedLoansContract.GroupedLoansItemView, View.OnClickListener {
    ...
    public GroupedLoansItemViewHolder(View itemView, GroupedLoansContract.Presenter presenter) {
        super(itemView);
    ...
    public void onClick(View view) {
        presenter.onLoanSelected(getAdapterPosition());
    }
