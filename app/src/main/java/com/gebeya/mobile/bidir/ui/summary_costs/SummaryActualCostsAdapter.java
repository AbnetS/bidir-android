...
public class SummaryActualCostsAdapter extends RecyclerView.Adapter<SummaryCostsItemHolder> {

    private final SummaryCostsContract.Presenter presenter;
    private final LayoutInflater inflater;

    public SummaryActualCostsAdapter(@NonNull SummaryCostsContract.Presenter presenter, @NonNull LayoutInflater inflater) {
    ...
    public void onBindViewHolder(@NonNull SummaryCostsItemHolder holder, int position) {
        presenter.onBindActualItemView(holder, position);
    }

    @Override
    public int getItemCount() {
        return presenter.getActualCount();
    }
}
